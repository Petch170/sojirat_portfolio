...
const Contact = () => {
  const sendEmail =(e)=>{
    ...
    emailjs.sendForm(import.meta.env.VITE_ID, import.meta.env.VITE_TEMPLATE_ID, e.target, import.meta.env.VITE_Public_Key)
    .then((result) => {
  ...
  return (
    <div id="contact" className=" max-w-[1040px] m-auto md:pl-20 p-4 py-16">
      <h1 className=" py-4 text-4xl font-bold text-center text-blue-300">
        Contact
      </h1>
