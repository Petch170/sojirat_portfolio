      ...
      <div className=" w-full h-screen top-0 left-0 bg-white/60 absolute  ">
        ...
        {/* max-w-[1040px] */}
          ...
          <div className=" max-w-[700px] h-full w-full flex justify-center items-center flex-col ">
            ...
            <div className="flex items-center pt-6 max-w-[200px] px-5"><a href="#" className=" flex justify-between items-center gap-3 p-2 rounded-xl border border-blue-900 bg-blue-300 text-gray-800 sm:tex-xl text-md font-semibold"><FaCloudDownloadAlt className=" cursor-pointer size-5 lg:size-7 items-center" />My CV</a></div>
          </div>
          <div className="max-w-[700px] h-[80%] w-[80%] justify-center items-center flex ">
            <img
              src={mypic}
              alt="myPic"
